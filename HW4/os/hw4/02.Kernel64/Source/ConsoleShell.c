...
SHELLCOMMANDENTRY gs_vstCommandTable[] =
{
	...
	{ "showgp", "show task graph", kShowTaskGraph },
	{ "teststart", "start scheduling test", kTestScheduling },
};                                     
...
static void kTestScheduling( const char* pcParameterBuffer )
{
    ...
    GraphCheckZero(); //scheduling process     
    //fairness_GraphCheckZero(); // scheduling fairness
